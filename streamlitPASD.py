...
st.write("Dataset Global Superstore yang dipakai")
dfgsuse
#------------------------------------------------------------------------------------------------------
...
st.write( "Boxplot Outliers Distribution dari dataset dengan Outliers" )
def show_boxplot(df):
...
st.write( "Boxplot Outliers Distribution dari dataset tanpa Outliers" )
